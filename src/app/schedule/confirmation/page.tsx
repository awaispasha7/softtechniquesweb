...
function ConfirmationContent() {
  ...
  return (
    <div className="relative w-full max-w-2xl">
        ...
        {/* Confirmation Card */}
        <div className={`bg-[#2d4539]/80 backdrop-blur-sm rounded-2xl border border-[#4a6b5f]/50 shadow-2xl p-8 transition-all duration-1000 transform ${
          ...
          <div className="text-center space-y-4">
            ...
            <div className="bg-[#3a5a4f]/60 rounded-lg p-6 border border-[#4a6b5f] space-y-3">
              <p className="text-gray-300 text-lg">
                We&apos;ve received your consultation request and will contact you soon to confirm the details.
              </p>
              
              {(date || time) && (
                <div className="pt-4 border-t border-[#4a6b5f]">
            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <button
                  onClick={() => router.push('/schedule')}
                  className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02]"
                >
                  Schedule Another
                </button>
                <button
                  onClick={() => router.push('/')}
                  className="px-6 py-3 bg-transparent border border-[#4a6b5f] hover:border-green-500 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02]"
                >
                  Back to Home
                </button>
              </div>
...
export default function ConfirmationPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2d4539] via-[#3a5a4f] to-[#2d4539] flex items-center justify-center p-4">
      <Suspense fallback={
        <div className="relative w-full max-w-2xl">
          <div className="bg-[#2d4539]/80 backdrop-blur-sm rounded-2xl border border-[#4a6b5f]/50 shadow-2xl p-8 text-center">
            <div className="flex justify-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center animate-pulse">
