        ...
        <div className="w-full max-w-md relative z-10">
          <div className="bg-[#44559e] backdrop-blur-sm rounded-2xl sm:rounded-3xl border border-white/20 p-6 sm:p-8 shadow-2xl shadow-white/20">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-white/80">Sign in to manage your blog posts</p>
            </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#44559e] flex items-center justify-center">
