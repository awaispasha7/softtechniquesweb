          ...
          <div className="bg-[#29473d] backdrop-blur-sm rounded-3xl border border-white/20 p-8 shadow-2xl shadow-white/20">
            ...
            {success ? (
              <div className="space-y-6">
                ...
                <Link
                  href="/auth/login"
                  className="block w-full text-center bg-white text-[#29473d] hover:bg-white/90 py-3 px-6 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
                >
                  Back to Sign In
                </Link>
              </div>
